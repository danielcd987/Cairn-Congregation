        ...
        if(isset($_POST['searchsubmit'])){
            ...
            if($queryResults > 0){
                while($row = mysqli_fetch_assoc($Results)){ //have the search results go to profile
                    // echo  "<div class = 'searchalum'>
                    //         <ul>
                    //              <a href = 'profile.php'?UserNames=".$row['UserNames']."'>
                    //                 <div class = 'result-box'> 
                    //                     <li class = 'searchlistresults'> <h5 class = 'namesearch'> UserName: ".$row['UserNames']."</h5> </li>
                    //                     <li class = 'searchlistresults'> <h5 class = 'namesearch'> Occupation:".$row['occ']."</h5> </li>
                    //                     <li class = 'searchlistresults'> <h5 class = 'namesearch'> Age: ".$row['age']."</h5> </li>
                    //                 </div></a>
                    //        </ul>
                    //        </div>";
                    echo "<table>
