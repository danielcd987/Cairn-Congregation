      ...
      <h3>Edit Profile</h3>
        ...
        ?>
            ...
            <form action = "includes/editprofile.inc.php" method = "post" >
             ...
             <p>Password:</p><input type = "password" name = "pswd" placeholder = "Password"> <br> <br>
             <p>Retype Password:</p><input type = "password" name = "pswd2" placeholder = "Re-enter Password"> <br> <br>
